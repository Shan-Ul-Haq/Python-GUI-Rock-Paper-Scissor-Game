...
rock_btn = Button(input_frame, text = 'Rock', width = 20, bd = 0, bg = 'light green', pady = 5, command = lambda: player_choice(options[0]))
rock_btn.grid(row = 1, column = 1, padx = 10, pady = 5)

paper_btn = Button(input_frame, text = 'Paper', width = 15, bd = 0, bg = '#F68642', pady = 5, command = lambda: player_choice(options[1]))
